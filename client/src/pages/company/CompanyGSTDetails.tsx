...
import { useCompanyGSTDetailsForm } from "./hooks/useCompanyGSTDetailsForm";
import CompanyGSTDetailsFormFields from "./components/CompanyGSTDetailsFormFields";
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden bg-white select-none">
      ...
      <div className="flex-1 flex min-h-0">
        <CompanyGSTDetailsFormFields form={form} setField={setField} />
