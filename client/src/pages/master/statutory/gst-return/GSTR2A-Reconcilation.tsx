...
export default function GSTR2AReconciliation() {
  ...
  const grandTotal = [
    b2b, amend_b2b, cdn, amend_cdn, isd, import_boe, import_sez_boe,
  ...
  const rows: RowDef[] = [
    ...
    { type: "data", label: "Import of Goods from overseas on Bill of Entry",                  row: import_boe,     indent: 1 },
    { type: "data", label: "Import of Goods from SEZ Units/Developers on Bill of Entry",      row: import_sez_boe, indent: 1 },
  ];
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col font-sans text-xs pb-4">
        ...
        {loading && <EmptyState message="Loading GSTR-2A reconciliation data…" className="italic" />}
