...
import { useCenvatOpeningBalance } from "./useCenvatOpeningBalance";
import { CenvatOpeningBalanceForm } from "./CenvatOpeningBalanceForm";
...
export default function CenvatOpeningBalanceCreate() {
  ...
  const { form, setField, loading, error, setError, success, setSuccess, save } =
    useCenvatOpeningBalance({ companyId });
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white select-none">
      <PageTitleBar title="CENVAT Opening Balance" subtitle={selectedCompany?.name} />
      ...
      <div className="flex-1 flex min-h-0">
        <CenvatOpeningBalanceForm form={form} setField={setField} firstFieldAutoFocus />
