...
export default function ExciseRDCreate({ returnPath = "/master/create" }: { returnPath?: string } = {}) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white select-none">
      <PageTitleBar title="Excise Registration Details" subtitle={selectedCompany?.name} />
      ...
      <div className="flex-1 flex min-h-0">
        <ExciseRegistrationDetailsForm form={form} setField={setField} firstFieldAutoFocus />
