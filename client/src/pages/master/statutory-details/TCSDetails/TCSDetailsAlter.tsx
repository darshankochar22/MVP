...
export default function TCSDetailsAlter() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white select-none text-zinc-950">
      <PageTitleBar title="Company TCS Collector Details (Alteration)" subtitle={selectedCompany?.name} />
        ...
        {showPersonModal && (
          <div className="fixed inset-0 bg-zinc-900/40 z-9999 flex items-center justify-center backdrop-blur-[1px]">
            <form
              ...
              className="bg-white border border-zinc-400 w-145 shadow-2xl overflow-hidden flex flex-col font-mono text-[11px] text-zinc-950 animate-fade-in"
            >
              {/* Modal Header */}
