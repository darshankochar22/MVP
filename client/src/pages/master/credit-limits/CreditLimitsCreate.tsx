...
export default function CreditLimitsCreate({ returnPath = "/master/create" }: { returnPath?: string } = {}) {
  ...
  const openGroup = async (group: GroupType) => {
    ...
    const mapped: RowState[] = (res.ledgers || []).map((l: LedgerType) => ({
      ...
      name: l.name,
      credit_limit:
        l.credit_limit != null && Number(l.credit_limit) !== 0
          ? String(l.credit_limit)
          : "",
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white select-none">
      <PageTitleBar
        title="Multi Ledger Limit Alteration"
      ...
      <div className="flex-1 flex min-h-0">
        <div className="flex-1 flex flex-col min-h-0 border-r border-zinc-100">
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            {loading && (
              <div className="px-3 py-4 text-xs text-zinc-400">Loading…</div>
            )}
                ...
                >
                  ...
                  <div className="flex items-center justify-end gap-1">
                    <input
                      ...
                      onChange={(e) =>
                        setRow(idx, { credit_limit: e.target.value })
                      }
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setRow(idx, { credit_limit_type: e.target.value })
                      }
                  ...
                  <div className="flex items-center justify-end gap-1">
                    <input
                      ...
                      onChange={(e) =>
                        setRow(idx, { credit_period: e.target.value })
                      }
