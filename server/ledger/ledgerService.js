    ...
    try {
      ...
      if (data.statutory_details) {
        await db.insert(ledgerStatutoryDetails).values({
          ...
          dutyHead: data.statutory_details.duty_head || null,
          gstTaxType: data.statutory_details.gst_tax_type || null,
          serviceTaxHead: data.statutory_details.service_tax_head || null,
          natureOfGoods: data.statutory_details.nature_of_goods || null,
