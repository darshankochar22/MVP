...
const ledgers = sqliteTable('ledgers', {
  ...
  exciseHsnCode: text('excise_hsn_code'),
  exciseReportingUom: text('excise_reporting_uom').default('Undefined'),
  exciseValuationType: text('excise_valuation_type').default('Undefined'),
  exciseRate: real('excise_rate').default(0),
  exciseRatePerUnit: real('excise_rate_per_unit').default(0),
  vatNatureOfTransaction: text('vat_nature_of_transaction').default('Undefined'),
  vatTaxRate: real('vat_tax_rate').default(0),
  vatTaxType: text('vat_tax_type').default('Unknown'),
