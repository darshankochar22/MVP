    ...
    try {
      ...
      const inserted = await db
        ...
        .values({
          ...
          vatNatureOfTransaction: data.vat_nature_of_transaction || null,
          vatPartyEntityType: data.vat_party_entity_type || null,
          vatTaxRate: data.vat_tax_rate ?? 0,
          vatTaxType: data.vat_tax_type || null,
          vatRevisedApplicability: data.vat_revised_applicability || null,
          exciseTariffName: data.excise_tariff_name || null,
          exciseHsnCode: data.excise_hsn_code || null,
          exciseReportingUom: data.excise_reporting_uom || null,
          exciseValuationType: data.excise_valuation_type || null,
          exciseRate: data.excise_rate ?? 0,
          exciseRatePerUnit: data.excise_rate_per_unit ?? 0,
    ...
    try {
      ...
      await db
        ...
        .set({
          ...
          isPrimary: data.is_primary !== undefined ? (data.is_primary ? 1 : 0) : group.is_primary,
          nature: data.nature !== undefined ? data.nature : group.nature,
          setAlterTdsDetails: data.set_alter_tds_details !== undefined ? (data.set_alter_tds_details ? 1 : 0) : group.set_alter_tds_details,
          setAlterTcsDetails: data.set_alter_tcs_details !== undefined ? (data.set_alter_tcs_details ? 1 : 0) : group.set_alter_tcs_details,
          setAlterOtherStatutoryDetails: data.set_alter_other_statutory_details !== undefined ? (data.set_alter_other_statutory_details ? 1 : 0) : group.set_alter_other_statutory_details,
          setAlterServiceTaxDetails: data.set_alter_service_tax_details !== undefined ? (data.set_alter_service_tax_details ? 1 : 0) : group.set_alter_service_tax_details,
          setAlterVatDetails: data.set_alter_vat_details !== undefined ? (data.set_alter_vat_details ? 1 : 0) : group.set_alter_vat_details,
          setAlterExciseDetails: data.set_alter_excise_details !== undefined ? (data.set_alter_excise_details ? 1 : 0) : group.set_alter_excise_details,
          ...
          behavesLikeSubledger: data.behaves_like_subledger !== undefined ? (data.behaves_like_subledger ? 1 : 0) : group.behaves_like_subledger,
          showNetDebitCredit: data.show_net_debit_credit !== undefined ? (data.show_net_debit_credit ? 1 : 0) : group.show_net_debit_credit,
          usedForCalculation: data.used_for_calculation !== undefined ? (data.used_for_calculation ? 1 : 0) : group.used_for_calculation,
          ...
          vatNatureOfTransaction: data.vat_nature_of_transaction !== undefined ? data.vat_nature_of_transaction : group.vat_nature_of_transaction,
          vatPartyEntityType: data.vat_party_entity_type !== undefined ? data.vat_party_entity_type : group.vat_party_entity_type,
          vatTaxRate: data.vat_tax_rate !== undefined ? data.vat_tax_rate : group.vat_tax_rate,
          vatTaxType: data.vat_tax_type !== undefined ? data.vat_tax_type : group.vat_tax_type,
          vatRevisedApplicability: data.vat_revised_applicability !== undefined ? data.vat_revised_applicability : group.vat_revised_applicability,
          exciseTariffName: data.excise_tariff_name !== undefined ? data.excise_tariff_name : group.excise_tariff_name,
          exciseHsnCode: data.excise_hsn_code !== undefined ? data.excise_hsn_code : group.excise_hsn_code,
          exciseReportingUom: data.excise_reporting_uom !== undefined ? data.excise_reporting_uom : group.excise_reporting_uom,
          exciseValuationType: data.excise_valuation_type !== undefined ? data.excise_valuation_type : group.excise_valuation_type,
          exciseRate: data.excise_rate !== undefined ? data.excise_rate : group.excise_rate,
          exciseRatePerUnit: data.excise_rate_per_unit !== undefined ? data.excise_rate_per_unit : group.excise_rate_per_unit,
