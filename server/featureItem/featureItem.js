const FEATURE_ITEMS = [
  ...
  { group_key: 'online',    feature_key: 'enable_payment_request_qr',        feature_name: 'Enable Payment Request QR',              description: 'Generate QR codes for payment requests',               control_type: 'boolean', default_value_boolean: 1, display_order: 3, is_mandatory: 0 },
