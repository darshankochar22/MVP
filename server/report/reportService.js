...
module.exports = {
  ...
  journalRegister: async (company_id, fy_id) => {
    try {
  ...
  debitNoteRegister: async (company_id, fy_id) => {
    try {
  ...
  creditNoteRegister: async (company_id, fy_id) => {
    try {
  ...
  purchaseRegister: async (company_id, fy_id) => {
    try {
  ...
  salesRegister: async (company_id, fy_id) => {
    try {
