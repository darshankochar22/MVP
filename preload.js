...
contextBridge.exposeInMainWorld('api', {
    ...
    report: {
        ...
        godownItemMonthly: (company_id, fy_id, godown_id, item_id)                 => invoke('report:godownItemMonthly', { company_id, fy_id, godown_id, item_id }),
        godownVouchers:    (company_id, fy_id, godown_id, item_id, from_date, to_date) => invoke('report:godownVouchers', { company_id, fy_id, godown_id, item_id, from_date, to_date }),
        stockItemVouchers: (company_id, fy_id, item_id, from_date, to_date)            => invoke('report:stockItemVouchers', { company_id, fy_id, item_id, from_date, to_date }),
        stockCategoryItems: (company_id, fy_id, category_id)                            => invoke('report:stockCategoryItems', { company_id, fy_id, category_id }),
        inventoryRegisterMonthly:  (company_id, fy_id, voucher_type)                     => invoke('report:inventoryRegisterMonthly', { company_id, fy_id, voucher_type }),
        inventoryRegisterVouchers: (company_id, fy_id, voucher_type, from_date, to_date) => invoke('report:inventoryRegisterVouchers', { company_id, fy_id, voucher_type, from_date, to_date }),
        ...
        stockGroupAnalysis:       (company_id, fy_id) => invoke('report:stockGroupAnalysis', { company_id, fy_id }),
        stockGroupAnalysisItems:      (company_id, fy_id, group_id)    => invoke('report:stockGroupAnalysisItems', { company_id, fy_id, group_id }),
        stockAgeingAnalysis:          (company_id, fy_id, group_id, as_at, fy_start, periods) => invoke('report:stockAgeingAnalysis', { company_id, fy_id, group_id, as_at, fy_start, periods }),
        ...
        employeesWithoutEmail:  (company_id, fy_id) => invoke('report:employeesWithoutEmail',  { company_id, fy_id }),
       ...
       paymentRegisterVouchers: (company_id, fy_id, from_date, to_date) => invoke('report:paymentRegisterVouchers', { company_id, fy_id, from_date, to_date }),
       receiptRegisterVouchers: (company_id, fy_id, from_date, to_date) => invoke('report:receiptRegisterVouchers', { company_id, fy_id, from_date, to_date }),
       ...
       salesRegisterVouchers:      (company_id, fy_id, from_date, to_date) => invoke('report:salesRegisterVouchers',      { company_id, fy_id, from_date, to_date }),
       purchaseRegisterVouchers:   (company_id, fy_id, from_date, to_date) => invoke('report:purchaseRegisterVouchers',   { company_id, fy_id, from_date, to_date }),
       journalRegisterVouchers:    (company_id, fy_id, from_date, to_date) => invoke('report:journalRegisterVouchers',    { company_id, fy_id, from_date, to_date }),
       debitNoteRegisterVouchers:  (company_id, fy_id, from_date, to_date) => invoke('report:debitNoteRegisterVouchers',  { company_id, fy_id, from_date, to_date }),
       creditNoteRegisterVouchers: (company_id, fy_id, from_date, to_date) => invoke('report:creditNoteRegisterVouchers', { company_id, fy_id, from_date, to_date }),
    },
    banking: {
